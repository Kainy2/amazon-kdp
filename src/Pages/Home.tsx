...
const Home = () => {
  return (
    <div className=''>
      ...
      <section className=' font-circularstd font-medium text-zinc-900'>
        <section className='py-20 px-[8%]'>

          <Text className='font-bold mb-14'>
            I GIVE UP!!!!
          </Text>
          ...
          <Text>
            (Input your favourite thought here) 😎
          </Text>
        </section> 

        <section className='py-20 px-[8%] bg-orange-600 text-orange-50 '>
          <Text className='font-bold mb-14'>
          ...
          <Text>
            (Testimonial - A video and a picture)
          </Text>
      ...
      <section className='py-20 px-[8%] '>
          ...
          <Text className='font-bold mb-14 uppercase'>
      ...
      <section className='py-20 px-[8%] '>
          ...
          <Text>
            CALL TO ACTION BUTTON - Remember to CLICK HERE to have access to the free video recorded just for you..
          </Text>
