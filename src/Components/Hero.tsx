...
import moneyHero from '../Assets/money-hero.jpeg'
...
const Hero = () => {
  return (
    <>
      ...
      <section style={ { background: `url(${ moneyHero }) rgba(39, 39, 42, 0.85) center`, backgroundBlendMode: 'multiply', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' } } id='hero' className={ `flex h-[70vh] items-center my-auto  text-gray-200 shadow-zinc-800` }>
